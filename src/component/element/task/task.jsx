...
const Task = ()=> {
    return (
        <div>
            <PageHeader currentpage="Task" activepage="Element" mainpage="Task" />
				...
				<div className="col-span-12">
					<div className="box">
						<div className="box-header">
							<div className="flex">
								<h5 className="box-title my-auto">Task Summary</h5>
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap">
									<thead className="bg-gray-50 dark:bg-black/20">
										<tr className="">
											...
											<th scope="col" className="dark:text-white/80">Task</th>
